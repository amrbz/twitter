    ...
    value: function retweet(e) {
      ...
      var req = __WEBPACK_IMPORTED_MODULE_5_axios___default.a.post('http://127.0.0.1:7610/api/v1.0/tweets', {
        ...
        if (response.status === 201) {
          ...
          var arr = _this4.state.tweets.list === false && _this4.state.tweets.length === 0 ? [response.data] : [response.data].concat(_this4.state.tweets.list);
...
//# sourceMappingURL=3.9f7c2e4ce166d7cabb21.hot-update.js.map