...
(function () {
  ...
  reactHotLoader.register(containerStyle, 'containerStyle', '/opt/web/components/Header.js');
...
(function () {
  ...
  reactHotLoader.register(layoutStyle, 'layoutStyle', '/opt/web/pages/index.js');
  reactHotLoader.register(_default, 'default', '/opt/web/pages/index.js');
  leaveModule(module);
})();
